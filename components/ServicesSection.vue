...
import designIcon from "~/assets/images/designIconNew.webp";
import qaIcon from "~/assets/images/qaIcon.webp";
import dynamicIcon from "~/assets/images/microdynaIcon.webp";
